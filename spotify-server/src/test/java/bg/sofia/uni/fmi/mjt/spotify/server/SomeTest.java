...
public class SomeTest {
    ...
    public void testPlaying() throws IOException, UnsupportedAudioFileException, LineUnavailableException, InterruptedException {
        FileInputStream inputStream = new FileInputStream(new File("src\\main\\resources\\songs\\sample.wav"));
        AudioInputStream stream = AudioSystem.getAudioInputStream(new File("src\\main\\resources\\songs\\sample.wav"));
